...
ALL_LIBS=$(boost_LIBDIR) $(dali_LIBDIR) $(galois_eda_LIBDIR) $(phydb_LIBDIR) \
	 $(PANDR_PIECES) $(GALOIS_EDA_PIECES) -lverilog_sh -lactchpopt -lactchpsdt -lactchpring -lactchpdecomp -lactchp2prspass -lexpropt_sh $(DALI_GUI_QT_LIBS)

#$(ACT_HOME)/lib/libabc.so
