...
static struct LispCliCommand ckt_cmds[] = {
  ...
  { "map", "ckt:map - generate transistor-level description",
    process_ckt_map },
  { "save_sp", "ckt:save_sp <file> - save SPICE netlist to <file>",
    process_ckt_save_sp },
  { "mk-nets", "ckt:mk-nets - preparation for DEF generation",
    process_ckt_mknets },
  { "save_prs", "ckt:save_prs <file> - save flat production rule set to <file> for simulation",
    process_ckt_save_prs },
  { "save_lvp", "ckt:save_lprs <file> - save flat production rule set to <file> for lvp",
    process_ckt_save_lvp },
  { "save_sim", "ckt:save_sim <file-prefix> - save flat .sim/.al file",
    process_ckt_save_sim },
  { "save_v", "ckt:save_v <file> - save Verilog netlist to <file>",
    process_ckt_save_v },
